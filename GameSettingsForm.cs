...
namespace GameForm
{
    public partial class GameSettingsForm : Form
    {
        ...
        {
            this.m_rows = (int)numRows.Value;
            this.m_cols = (int)numCols.Value;
        ...
        private void numCols_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value < MIN_VALUE || value > MAX_VALUE)
            {
                ...
                // Reset back to a safe value
                numCols.Value = MIN_VALUE;
            }
            else
            {
                this.m_cols = value;
